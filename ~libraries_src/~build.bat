...
::                                                                                                     
java -jar ~compiler.jar --js digibyte.min.js  --js bip38d.min.js --js bip39.min.js --js gibberish-aes.min.js --js sjcl.min.js --js xmr.min.js --js digiQR.min.js --js_output_file ~~temp.js --compilation_level WHITESPACE_ONLY
