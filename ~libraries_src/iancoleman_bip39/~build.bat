...
IF NOT EXIST %~dp1~compiler.jar GOTO missingcompiler
...
java -jar %~dp1~compiler.jar --js %~dp0myextensions.js --js %~dp0levenshtein.js --js %~dp0sjcl-bip39.js --js %~dp0wordlist.js --js %~dp0jsbip39.js --js %~dp0biginteger.js --js %~dp0mycode.js --js_output_file %~dp0~~temp.js --compilation_level SIMPLE 1>NUL
IF NOT EXIST %~dp0~~temp.js GOTO failed
IF EXIST %~dp1bip39.min.js DEL %~dp1bip39.min.js
copy /b %~dp1~wrapperStart.js + %~dp0bitcoinjs-3.3.2-mkc.js + %~dp1~wrapperEnd.js + %~dp1~wrapperStart.js + %~dp0~~temp.js + %~dp1~wrapperEnd.js %~dp1bip39.min.js 1>NUL
del %~dp0~~temp.js
IF NOT EXIST %~dp1bip39.min.js GOTO failed
