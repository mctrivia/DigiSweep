...
(function(u){function y(){for(var a=u.getElementsByClassName("DigiQR"),b=0;b<a.length;b++){var c=a[b].getAttribute("uri"),d=parseInt(a[b].getAttribute("size")||300),l=parseInt(a[b].getAttribute("logo")||6),k=parseFloat(a[b].getAttribute("r")||.5),n="digiid://"==c.toLowerCase().substr(0,9)?1:0;a[b].src=p(c,d,l,k,n)}}function p(a,b,c,d,l){var r=a.indexOf(":")+1;"dgb1"==a.substr(r,4)&&-1==a.indexOf("?")&&(a=a.toUpperCase());return A({data:a,size:b,logo:c,r:d,symbol:l})}function C(a,b,v){var d=.5*a,l=
d*b;b=d-l;for(var m=d+l,r=[],g=0;16>g;g++){var e=function(a,b,d,e,h,g,v,r,m,q,D,z,p,B,u,y){f[n]();f.moveTo(a,b);f[c](d,e);f[c](h,g);f[c](v,r);f.arc(m,q,l,D*Math.PI,z*Math.PI);f[c](p,B);f[c](u,y);f[c](a,b);f[k]();f.fill()},q=function(a,b,d,e,h,g,v,r,m,q,p,z){f[n]();f.moveTo(a,b);f[c](d,e);f[c](h,g);f.arc(v,r,l,m*Math.PI,q*Math.PI);f[c](p,z);f[c](a,b);f[k]();f.fill()},h=u.createElement("canvas");h.height=h.width=a;var f=h.getContext("2d");f.fillStyle=v;1!=g&&9!=g||q(a,a,d,a,d,m,m,m,1,1.5,a,d);8!=g&&
9!=g||q(0,0,d,0,d,b,b,b,0,.5,0,d);4!=g&&6!=g||q(a,0,a,d,m,d,m,b,.5,1,d,0);2!=g&&6!=g||q(0,a,0,d,b,d,b,m,1.5,0,d,a);3==g&&f.fillRect(0,d,a,d);12==g&&f.fillRect(0,0,a,d);10==g&&f.fillRect(0,0,d,a);5==g&&f.fillRect(d,0,d,a);15==g&&f.fillRect(0,0,a,a);7==g&&e(a,a,a,0,d,0,d,b,b,b,0,.5,0,d,0,a);11==g&&e(0,a,a,a,a,d,m,d,m,b,.5,1,d,0,0,0);13==g&&e(a,0,0,0,0,d,b,d,b,m,1.5,0,d,a,a,a);14==g&&e(0,0,0,a,d,a,d,m,m,m,1,1.5,a,d,a,0);r[g]=h}return r}function E(a){a[n]();a.fillStyle="#0066cc";a.arc(0,0,.891,0,2*Math.PI);
a[k]();a.fill();a[n]();a.fillStyle="#002352";a.arc(0,0,.709,0,2*Math.PI);a[k]();a.fill()}function F(a,r){a.save();0==r?(a.fillStyle="#FFFFFF",a[n](),a.moveTo(.245,-.361),a[c](.27,-.428),a[b](.273,-.435,.268,-.442,.261,-.442),a[c](.166,-.442),a[c](.136,-.363),a[c](.094,-.363),a[c](.118,-.428),a[b](.121,-.435,.116,-.442,.109,-.442),a[c](.014,-.442),a[c](-.016,-.363),a[c](-.313,-.363),a[b](-.327,-.363,-.339,-.356,-.346,-.344),a[c](-.42,-.214),a[c](-.317,-.214),a[c](.134,-.214),a[b](.152,-.214,.17,-.211,
.187,-.204),a[b](.221,-.19,.259,-.16,.249,-.091),a[b](.233,.024,.116,.228,-.139,.231),a[c](-.007,-.111),a[b](-.002,-.125,-.012,-.14,-.028,-.14),a[c](-.204,-.14),a[c](-.417,.383),a[b](-.417,.383,-.374,.388,-.307,.388),a[c](-.329,.443),a[c](-.231,.443),a[b](-.223,.443,-.216,.439,-.213,.431),a[c](-.195,.384),a[b](-.18,.383,-.166,.381,-.151,.379),a[c](-.175,.443),a[c](-.078,.443),a[b](-.07,.443,-.063,.439,-.061,.431),a[c](-.033,.359),a[b](.127,.323,.298,.243,.4,.076),a[b](.606,-.26,.392,-.346,.245,-.361),
a[k](),a.fill()):(a.miterLimit="0",a.save(),a.save(),a.globalAlpha="0.3",a.fillStyle="#FFFFFF",a[n](),a.moveTo(.163,.589),a[b](.161,.589,.158,.589,.156,.588),a[b](.066,.562,.008,.526,-.053,.461),a[b](-.132,.376,-.175,.264,-.175,.144),a[b](-.175,.045,-.098,-.035,-.001,-.035),a[b](.095,-.035,.172,.045,.172,.144),a[b](.172,.209,.225,.262,.289,.262),a[b](.353,.262,.406,.209,.406,.144),a[b](.406,-.085,.223,-.271,-.002,-.271),a[b](-.162,-.271,-.308,-.174,-.374,-.026),a[b](-.395,.023,-.407,.08,-.407,.144),
a[b](-.407,.192,-.403,.266,-.369,.363),a[b](-.364,.379,-.371,.396,-.386,.402),a[b](-.401,.408,-.417,.4,-.423,.384),a[b](-.45,.304,-.464,.226,-.464,.144),a[b](-.464,.072,-.45,.005,-.425,-.052),a[b](-.35,-.221,-.184,-.33,-.002,-.33),a[b](.254,-.33,.462,-.117,.462,.145),a[b](.462,.244,.384,.324,.289,.324),a[b](.193,.324,.115,.244,.115,.145),a[b](.115,.081,.062,.028,-.002,.028),a[b](-.066,.028,-.119,.081,-.119,.145),a[b](-.119,.249,-.081,.346,-.014,.419),a[b](.04,.476,.091,.507,.171,.53),a[b](.186,.535,
.194,.551,.191,.568),a[b](.187,.58,.176,.589,.163,.589),a[c](.163,.589),a[c](.163,.589),a[k](),a.moveTo(.277,.464),a[b](.21,.464,.151,.445,.102,.41),a[b](.018,.349,-.031,.249,-.031,.144),a[b](-.031,.127,-.018,.114,-.003,.114),a[b](.012,.114,.025,.128,.025,.144),a[b](.025,.229,.065,.31,.133,.36),a[b](.173,.389,.22,.404,.277,.404),a[b](.291,.404,.313,.402,.336,.398),a[b](.351,.395,.365,.406,.368,.422),a[b](.371,.438,.361,.454,.346,.457),a[b](.312,.464,.285,.464,.277,.464),a[c](.277,.464),a[c](.277,
.464),a[k](),a.moveTo(-.126,.577),a[b](-.134,.577,-.141,.574,-.147,.568),a[b](-.195,.514,-.222,.481,-.26,.408),a[b](-.299,.333,-.32,.242,-.32,.144),a[b](-.32,-.037,-.176,-.183,-.001,-.183),a[b](.174,-.183,.318,-.037,.318,.144),a[b](.318,.161,.305,.174,.29,.174),a[b](.275,.174,.262,.16,.262,.144),a[b](.262,-.003,.144,-.123,-.001,-.123),a[b](-.146,-.123,-.264,-.004,-.264,.144),a[b](-.264,.231,-.246,.312,-.212,.377),a[b](-.176,.447,-.151,.478,-.108,.524),a[b](-.097,.536,-.097,.555,-.109,.567),a[b](-.112,
.574,-.119,.577,-.126,.577),a[c](-.126,.577),a[c](-.126,.577),a[k](),a.moveTo(-.479,-.156),a[b](-.485,-.156,-.491,-.158,-.496,-.161),a[b](-.509,-.171,-.512,-.19,-.503,-.204),a[b](-.447,-.289,-.376,-.355,-.291,-.402),a[b](-.114,-.501,.112,-.502,.289,-.403),a[b](.374,-.356,.444,-.29,.501,-.206),a[b](.511,-.192,.508,-.173,.495,-.164),a[b](.482,-.155,.465,-.157,.456,-.171),a[b](.405,-.247,.341,-.307,.264,-.349),a[b](.103,-.438,-.104,-.438,-.265,-.348),a[b](-.341,-.305,-.406,-.245,-.455,-.168),a[b](-.461,
-.16,-.47,-.156,-.479,-.156),a[c](-.479,-.156),a[c](-.479,-.156),a[k](),a.moveTo(.327,-.474),a[b](.322,-.474,.318,-.475,.314,-.478),a[b](.206,-.538,.112,-.564,.001,-.564),a[b](-.111,-.564,-.217,-.535,-.313,-.478),a[b](-.327,-.47,-.343,-.475,-.351,-.49),a[b](-.358,-.506,-.353,-.523,-.339,-.532),a[b](-.235,-.594,-.119,-.625,.002,-.625),a[b](.121,-.625,.227,-.596,.341,-.532),a[b](.355,-.524,.361,-.506,.354,-.491),a[b](.346,-.48,.337,-.474,.327,-.474),a[c](.327,-.474),a[c](.327,-.474),a[k](),a.fill(),
a.restore(),a.save(),a.fillStyle="#FFFFFF",a[n](),a.moveTo(-.34,-.532),a[b](-.354,-.523,-.359,-.506,-.352,-.49),a[b](-.344,-.475,-.328,-.47,-.314,-.478),a[b](-.217,-.535,-.112,-.564,-.001,-.564),a[c](-.001,-.625),a[b](-.121,-.625,-.236,-.593,-.34,-.532),a[k](),a.fill(),a[n](),a.moveTo(-.29,-.402),a[b](-.375,-.355,-.446,-.289,-.502,-.204),a[b](-.511,-.19,-.508,-.172,-.495,-.162),a[b](-.49,-.158,-.484,-.156,-.478,-.156),a[b](-.469,-.156,-.46,-.16,-.456,-.169),a[b](-.405,-.246,-.341,-.307,-.265,-.349),
a[b](-.184,-.394,-.092,-.416,0,-.416),a[c](0,-.477),a[b](-.101,-.476,-.202,-.452,-.29,-.402),a[k](),a.fill(),a[n](),a.moveTo(0,-.183),a[b](-.176,-.183,-.319,-.037,-.319,.144),a[b](-.319,.242,-.298,.332,-.259,.408),a[b](-.222,.481,-.195,.514,-.147,.567),a[b](-.141,.574,-.134,.577,-.126,.577),a[b](-.119,.577,-.112,.574,-.107,.567),a[b](-.095,.556,-.095,.537,-.106,.525),a[b](-.15,.477,-.174,.448,-.21,.378),a[b](-.245,.312,-.263,.231,-.263,.144),a[b](-.263,-.003,-.145,-.123,0,-.123),a[c](0,-.123),a[c](0,
-.183),a[c](0,-.183),a[k](),a.fill(),a[n](),a.moveTo(-.002,-.332),a[b](-.184,-.332,-.35,-.222,-.425,-.053),a[b](-.45,.005,-.464,.071,-.464,.144),a[b](-.464,.226,-.45,.304,-.423,.384),a[b](-.417,.4,-.401,.407,-.386,.402),a[b](-.371,.397,-.365,.379,-.369,.363),a[b](-.404,.266,-.407,.191,-.407,.144),a[b](-.407,.081,-.395,.023,-.374,-.026),a[b](-.308,-.175,-.162,-.271,-.002,-.271),a[b](-.001,-.271,-.001,-.271,0,-.271),a[c](0,-.332),a[b](-.001,-.332,-.001,-.332,-.002,-.332),a[k](),a.fill(),a[n](),a.moveTo(-.031,
.144),a[b](-.031,.194,-.02,.242,0,.286),a[c](0,.114),a[b](-.001,.114,-.002,.114,-.003,.114),a[b](-.019,.114,-.031,.127,-.031,.144),a[k](),a.fill(),a[n](),a.moveTo(-.014,.418),a[b](-.081,.345,-.119,.247,-.119,.144),a[b](-.119,.079,-.066,.026,-.002,.026),a[b](-.001,.026,-.001,.026,0,.026),a[c](0,-.035),a[c](-.001,-.035),a[b](-.098,-.035,-.175,.045,-.175,.144),a[b](-.175,.264,-.132,.376,-.053,.46),a[b](-.035,.48,-.018,.495,0,.51),a[c](0,.432),a[b](-.005,.427,-.009,.423,-.014,.418),a[k](),a.fill(),a.restore(),
a.restore(),a.save(),a.fillStyle="#FFFFFF",a[n](),a.moveTo(.004,.701),a[b](.004,.704,.002,.706,-.001,.706),a[c](-.001,.706),a[b](-.003,.706,-.006,.704,-.006,.701),a[c](-.006,-.734),a[b](-.006,-.737,-.003,-.739,-.001,-.739),a[c](-.001,-.739),a[b](.002,-.739,.004,-.737,.004,-.734),a[c](.004,.701),a[k](),a.fill(),a.restore());a.restore()}function A(a){function b(a){function b(a,b){if(0>a||a>=h||0>b||b>=h)return 1;if(3==l){var d=(h-1)/2,e=a-d,d=b-d;if(e*e+d*d<=c)return 1}return!q.isDark(a,b)}a=C(f,m,
a);for(var c=t/f,c=c*c,d=-1;d<=h;d++)for(var g=-1;g<=h;g++){var k=8*b(g,d)+4*b(g+1,d)+2*b(g,d+1)+b(g+1,d+1);e.drawImage(a[k],(g+.5)*f,(d+.5)*f)}}var c=a.data,d=a.size||200,l=a.logo||0,m=a.r||0,p=a.symbol||0,g="Byte";c==c.replace(/[^0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ \$\%\*\+\-\.\/\:]/g,"")&&(g="Alphanumeric");a=u.createElement("canvas");a.height=a.width=d;var e=a.getContext("2d"),q=qrcode(0,0<l?"H":"L");q.addData(c,g);q.make();var h=q.getModuleCount(),f=Math.floor(d/h),c=Math.floor((d-h*f)/2);e.save();
e.translate(c,c);e.fillStyle="#000000";e.fillRect(0,0,h*f,h*f);var c=f*h/2,t=f,t=5>l?t*Math.min(Math.floor((Math.sqrt(.2*h*h)+1)/2)-.5,.5*(h-16)):7>l?.5*t*(h-1):t*Math.min(1.12*Math.sqrt(h*h*.5)-11.08,.56*h);b("#FFFFFF");e.save();e.transform(t,0,0,t,c,c);e.save();1==l&&(e[n](),e.fillStyle="#FFFFFF",e.rect(-1,-1,2,2),e[k](),e.fill());2==l&&(e[n](),e.fillStyle="#FFFFFF",e.arc(0,0,1,0,2*Math.PI),e[k](),e.fill());0<l&&(E(e),F(e,p));e.restore();e.restore();if(5==l||7==l){e.save();e.transform(f,0,0,f,f/
2,f/2);e.save();for(var w=0;w<h;w++)for(var x=0;x<h;x++)p=function(a,b){e.fillStyle=b;e[n]();e.arc(x,w,a,0,2*Math.PI);e[k]();e.fill()},5!=l||q.isDark(x,w)||p(.5,"rgba(255,255,255,0.5)"),7==l&&p(.2,q.isDark(x,w)?"#000000":"#FFFFFF");e.restore();e.restore()}6==l&&b("rgba(255,255,255,0.5)");e.restore();return a.toDataURL("image/jpg")}var b="bezierCurveTo",c="lineTo",n="beginPath",k="closePath";y();window.DigiQR={request:function(a,b,c,d,k){return p("digibyte:"+a+"?amount="+b.toFixed(8),c,d,k)},address:p,
explorer:function(a,b,c,d){return p("https://digiexplorer.info/address/"+a,b,c,d)},text:p,gen:A,id:function(a,b,c,d){return p(a,b,c,d,1)},auto:y}})(document);
})();
